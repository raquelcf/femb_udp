...
from femb_config_sbnd import FEMB_CONFIG
#from femb_config import FEMB_CONFIG
from subprocess import call

#<pulse mode> is the first argument pass but not used in this code!
if len(sys.argv) != 5 :
#if len(sys.argv) != 4 :
	print 'Invalid # of arguments, usage python doNoiseMeasurement <pulse mode> <gain> <shape> <baseline>'
	sys.exit(0)
